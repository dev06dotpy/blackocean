...
public class Sprite {
    public static Image ASTEROID1, SPACE;
    static {
        try {
            ASTEROID1 = ImageManager.loadImage("asteroid1.png");
            SPACE = ImageManager.loadImage("space_background.png");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
